...
import { videoDec } from '../../actions/VideoAction'
import Qs from 'query-string'
import SearchCss from '../../assets/css/search.module.css'
import { get_aboutVideo, get_videoComment } from '../../api/VideoApi'
...
class VideoDetail extends React.Component {
    ...
    componentDidMount() {
        ...
        store.dispatch(videoDec(keywords.keywords))
        // 视频的title
        ...
        // 页面加载获取相关视频
        get_aboutVideo(keywords.keywords)
            .then(res => {
                // console.log(res)
                this.setState({
        ...
        // 页面加载获取mv评论
        get_videoComment(keywords.keywords)
            .then(res => {
                console.log(res)
                this.setState({
    ...
    render() {
        ...
        let { videoOne } = store.getState().VideoReducer
        ...
        return (
            <Fragment>
                <div className={SearchCss.mvDiv}>
                    ...
                    <video src={videoOne} className={SearchCss.mvvideo} controls></video>
                </div>

...
import FT from  "../songlist/fotter.module.css"
//字体图标的引入
...
class SiRenFm extends React.Component{
    constructor(props){
        super(props)
        this.state={
        ...
        return(
            ...
            {/* 上面展示部分 */}
                ...
                <div style={{display:"flex",justifyContent:"space-around",marginTop:"20px",marginBottom:"20px"}}>
                    ...
                    <div onClick={this.shangyige.bind(this)} style={{display:"flex",flexDirection:"column"}}>
                    ...
                    <div onClick={this.xiayige.bind(this)} style={{display:"flex",flexDirection:"column"}}>
